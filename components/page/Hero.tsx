    ...
    return (
        <div className="background-hero">
            <div className="max-w-6xl">
                ...
                <h1 className="text-6xl sm:text-center text-left sm:px-0 px-4">Master your full-stack web development skills with this bootcamp.</h1>
                <p className="sm:text-center text-left sm:px-0 px-4 py-2">We will teach here evrything, that make you a good developer. This bootcamp include Recat, Next.js, Node.js, Databases like MongoDB/PostgreSQL</p>
