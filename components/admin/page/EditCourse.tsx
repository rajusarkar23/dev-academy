        ...
        >
          ...
          <div className="flex flex-row space-x-3">
            ...
            <div className="w-full">
              ...
              <Input
                defaultValue={items.courseHeading}
          ...
          <div className="flex flex-row space-x-3">
            <div className="w-full">
              ...
              <Input
                defaultValue={items.courseShortDescription}
            ...
            <div className="w-full">
              ...
              <Input
                defaultValue={items.courseInstrutor}
              ...
              {errors && (
                <p className="text-sm text-red-500">
                  {errors.courseInstructor?.message}
                </p>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-row space-x-3">
            <div className="w-full">
              ...
              <Input
                defaultValue={items.courseDuration}
            ...
            <div className="w-full">
              ...
              <Input
                defaultValue={items.studentCapacity}
          ...
          <div className="flex flex-row space-x-3">
            <div className="w-full">
              ...
              <Input
                defaultValue={items.courseEndDate}
            ...
            <div className="w-full">
              ...
              <Input
                defaultValue={items.courseStartDate}
          ...
          <div>
            ...
            <RichTextEditor
              content={items.courseDescription}
          ...
          <div className="w-full">
            ...
            <Input
              defaultValue={items.coursePrice}
          ...
          <div>
            <Input
              ...
              type="hidden"
              defaultValue={items.courseVideoURL}
            />
          </div>
          <div>
            <Input
              ...
              type="hidden"
              defaultValue={items.courseImageURL}
            />
          </div>
