            ...
            <form className="mx-auto max-w-lg space-y-4" onSubmit={handleSubmit(onsubmit)}>
                ...
                <div className="flex flex-row space-x-3">
                    <div className="w-full">
                        ...
                        <Input label="Course name" labelPlacement="inside" {...register("courseName", { required: "Course name is required" })} onChange={(e) => setName(e.target.value)} />
                        {errors && <p className="text-sm text-red-500">{errors.courseName?.message}</p>}
                    </div>
                    <div className="w-full">
                        <label className="font-semibold text-sm text-gray-300">Course heading:</label>
                        <Input label="Course heading" labelPlacement="inside" {...register("courseHeading", { required: "Course heading is required" })} />
                        {errors && <p className="text-sm text-red-500">{errors.courseHeading?.message}</p>}
                    </div>
                </div>
                ...
                <div className="flex flex-row space-x-3">
                    <div className="w-full">
                        ...
                        <Input label="Course short description" labelPlacement="inside"
                    ...
                    <div className="w-full">
                        ...
                        <Input label="Course instructor" labelPlacement="inside" {...register("courseInstructor", { required: "Course instructor is required" })} />
                ...
                <div className="flex flex-row space-x-3">
                    <div className="w-full">
                        ...
                        <Input label="Course duration" labelPlacement="inside" {...register("courseDuration", { required: "Course duration is required" })} />
                    ...
                    <div className="w-full">
                        ...
                        <Input label="Student capacity" labelPlacement="inside" {...register("studentCapacity", { required: "Student capacity is required" })} />
                ...
                <div className="flex flex-row space-x-3">
                    <div className="w-full">
                        ...
                        <Input label="Course end date" labelPlacement="inside" {...register("courseEndDate", { required: "Course end date is required" })} />
                    ...
                    <div className="w-full">
                        ...
                        <Input label="Course start date" labelPlacement="inside" {...register("courseStartDate", { required: "Course start date is required" })} />
                ...
                <div>
                    ...
                    <RichTextEditor content={courseDescription} setContent={setCourseDescription} />
                </div>

                <div>
                <label className="font-semibold text-sm text-gray-300">Course Price: eg- 1000 </label>
                        <Input label="Course price" labelPlacement="inside" {...register("coursePrice", { required: "Course price is required" })} />
